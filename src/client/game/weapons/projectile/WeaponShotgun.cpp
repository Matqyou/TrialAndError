...
static LoadTexture sTextureProjectile("entity.projectile.shotgun", AssetsClass::TexturePurpose::GUI_ELEMENT);
static LoadTexture sTextureWeapon("weapons.shotgun", AssetsClass::TexturePurpose::GUI_ELEMENT);
