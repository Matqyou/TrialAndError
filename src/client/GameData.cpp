...
bool GameData::InitializeImages()
{
...
void GameData::WaitForSoundToFinish()
{
	while (Mix_Playing(-1))
	{
		SDL_Delay(10);
...
bool GameData::Initialize()
{
	...
	std::cout << FStringColors("&8SDLimage %u.%u.%u", image_version->major, image_version->minor, image_version->patch)
			  << std::endl;
	std::cout << FStringColors("&8SDLmixer %u.%u.%u", mixer_version->major, mixer_version->minor, mixer_version->patch)
			  << std::endl;
	std::cout << FStringColors("&8SDLttf %u.%u.%u", ttf_version->major, ttf_version->minor, ttf_version->patch)
			  << std::endl;
	std::cout << FStringColors("&8---------------------------- &fInitializing &8----------------------------")
			  << std::endl;
